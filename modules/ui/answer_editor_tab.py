...
from src.openai_extractor import extract_json_from_text
...
def ask_openai_with_reference(ocr_text: str, answer_json: dict, question: str, model_name: str = "gpt-4o-2024-08-06", use_langchain: bool = False, temperature: float = 0.0) -> dict:
    """
    ...
    Args:
        ...
        temperature: 모델 temperature (기본값: 0.2, use_langchain=True일 때 사용)
